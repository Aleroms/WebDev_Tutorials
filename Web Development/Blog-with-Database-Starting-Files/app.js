...
//change this post array into an entry into the database
//create a connection
...
//create a model called Blog
const Post = mongoose.model("Post",blogSchema);
//create a document called posts


app.get("/", function(req, res){
  //use find() to rcv all documents added from /compose
...
app.post("/compose", function(req, res){
  //create a document and add it to Posts moddel
...
app.get("/posts/:postId", function(req, res){
  ...
  //find posts by id, exists -> render the postTitle
